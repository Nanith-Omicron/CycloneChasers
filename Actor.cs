...
namespace CycloneChasers
{
    ...
    public class Actor : Image, Ianimable
    {
        ...
        {  
            var Xpos = CORE._graphics.PreferredBackBufferWidth / 6 + SCREENPADDING;
        ...
        public virtual void UpdateAnimations(GameTime dt)
        {
            ...
            CORE._spriteBatch.Draw(e.sheet, position, s, color, rotation, Origin, scale, SpriteEffects.None, Layer);
        ...
        public virtual void Update(GameTime dt)
        {
            ...
            var screen = CORE._graphics.PreferredBackBufferWidth / 6;
